...
st.markdown("<h1 style = 'color: #7F27FF; text-align: center; font-family: helvetica '>STARTUP PROJECT</h1>", unsafe_allow_html = True)
...
st.image('pngwing.com.png',width= 20, use_column_width = True)
